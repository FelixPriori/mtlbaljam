...
type ShirtInstructions =
	keyof DictionaryType['mbj2026']['extrasPage']['shirt']['instructions']
...
export default function Shirt({
	...
	shirt: DictionaryType['mbj2026']['extrasPage']['shirt']
	lang: Locales
}) {
	...
	const creditLink = `<a href="https://www.instagram.com/alyssa_bobyssa" rel="noopener noreferrer" target="_blank">Alyssa</a>`
